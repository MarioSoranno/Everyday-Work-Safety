...
#include "cycfg_clocks.h"
    ...
    const cyhal_resource_inst_t CYBSP_EZI2C_CLK_DIV_obj = 
    {
        .type = CYHAL_RSC_CLOCK,
        .block_num = CYBSP_EZI2C_CLK_DIV_HW,
        .channel_num = CYBSP_EZI2C_CLK_DIV_NUM,
    };
...
void reserve_cycfg_clocks(void)
{
    ...
    cyhal_hwmgr_reserve(&CYBSP_EZI2C_CLK_DIV_obj);
#endif //defined (CY_USING_HAL)
}
