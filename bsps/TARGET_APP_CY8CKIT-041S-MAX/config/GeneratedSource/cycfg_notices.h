...
#define CYCFG_NOTICES_H
    ...
    #error "Unexpected MPN; expected DEVICE:=CY8C4149AZI-S593. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif
#endif
