...
#define CY_CAPSENSE_SENSOR_COUNT                                                 (4u)
#define CY_CAPSENSE_ELTD_COUNT                                                   (4u)
#define CY_CAPSENSE_PIN_COUNT                                                    (4u)
...
#define CY_CAPSENSE_SCAN_MODE                                                    (0u)
#define CY_CAPSENSE_TOTAL_CH_NUMBER                                              (2u)
#define CY_CAPSENSE_SLOT_COUNT                                                   (4u)
#define CY_CAPSENSE_SENSOR_CONNECTION_MODE                                       (1u)
...
#define CY_CAPSENSE_ISX_CALIBRATION_EN                                           (0u)
#define CY_CAPSENSE_SMARTSENSE_FULL_EN                                           (0u)
#define CY_CAPSENSE_SMARTSENSE_HW_EN                                             (1u)
...
#define CY_CAPSENSE_CSD_SHIELD_MODE                                              (0u)
#define CY_CAPSENSE_SHIELD_ACTIVE_EN                                             (0u)
#define CY_CAPSENSE_SHIELD_PASSIVE_EN                                            (0u)
...
#define CY_CAPSENSE_CSX_CDAC_COMP_DIV_AUTO_EN                                    (0u)
#define CY_CAPSENSE_CSX_CDAC_REF_AUTO_EN                                         (0u)
#define CY_CAPSENSE_ISX_CDAC_COMP_EN                                             (0u)
#define CY_CAPSENSE_ISX_CDAC_COMP_DIV_AUTO_EN                                    (0u)
#define CY_CAPSENSE_ISX_CDAC_REF_AUTO_EN                                         (0u)
...
#define CY_CAPSENSE_MULTI_PHASE_TX_ENABLED                                       (0u)
#define CY_CAPSENSE_MULTI_PHASE_ENABLED                                          (CY_CAPSENSE_MULTI_PHASE_TX_ENABLED)

/* Self-test */
#define CY_CAPSENSE_BIST_EN                                                      (1u)
#define CY_CAPSENSE_TST_WDGT_CRC_EN                                              (1u)
#define CY_CAPSENSE_TST_BSLN_INTEGRITY_EN                                        (1u)
#define CY_CAPSENSE_TST_RAW_INTEGRITY_EN                                         (1u)
#define CY_CAPSENSE_TST_SNS_SHORT_EN                                             (1u)
#define CY_CAPSENSE_TST_SNS_CAP_EN                                               (1u)
#define CY_CAPSENSE_TST_ELTD_CAP_EN                                              (1u)
